...
const Video = () => {
  return (
    <Section>
      <div
        className={`section-padding center-section ${style.page}`}
        id="video"
      >
        <h1>Video</h1>
        ...
        >
          <div className={style.video_container}>
            <FaYoutube />
            <img src={img} alt="watch video" className={style.video} />
          </div>
        </a>
        <Quote colour={Colour.TERTIARY} author="RSB Records">
          Andy Little takes us on a journey which straddles musical mountain
          peaks, valleys, deserts and the seas.
        </Quote>
        <LinkBtn
